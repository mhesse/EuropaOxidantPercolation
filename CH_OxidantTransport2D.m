...
% conduction and phase behavior in 2D. This is the next step after
% CH_with_conduction.m.
...
Param.dim.L = 30e3;            % Width of the domain  [m]
...
save(['solution_0.mat'],'tD','i','k','phiD','CD','headD','uD','qD','vD','pD','CD_tracer','cD_tracer','TD','Phi','Grid','Scales','Phase','ic','XDc','ZDc','X')
